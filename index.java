...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light">
		...
		<div class="collapse navbar-collapse"
			...
			<li class="nav-item">
				<a class="nav-link"
				href="https://github.com/kshivakumar27">Services</a>
			</li>
			<li class="nav-item">
				<a class="nav-link"
			...
			<li class="nav-item">
				<a class="nav-link"
				href="https://kshivakumar27.github.io/Yashiv99">products</a>
			</li>
			<li class="nav-item">
				<a class="nav-link"
				href=https://github.com/kshivakumar27>Contact Us</a>
			</li>
			</ul>
		</div>
		</div>
...
<p>
			...
			<a class="btn btn-primary"
				href="https://kshivakumar27.github.io/Yashiv99"
...
<p>
			...
			2. ReactJS, NodeJS
			3. Angualr
			4. Php, Javascript, html, css
			5. Mysql, Postgresql, Mongodb, git, aws(hosting static single pages)
			</p>
		...
		<div class="col-md-4" id="service-col3">
			...
			alt="..."
			/>
			<h3>Portfolio's and Good knowledge on aws, Azure & Selenium</h3>
			
<p>
			I have a good knowledge in Selenium python testing, 
			Manual testing,Api testing,In aws hosting static web pages,Creating virtual environment
			In azure commiting projects and running piplines(setups for running projects in piplines)
	...
	<div class="container-fluid" id="about-container">
		...
		<div class="col-md-6" id="about-col">
			...
			<ul>
			<li>
				Probuct is all about Delivering High
				Quality web design and development
				services, Cost effective and
				reliable solutions.
			</li>
			<li>Company trainee projects ex Infosys, tcs, L & T</li>
			...
			<li>I thank all who believed in us</li>
			</ul>
		</div>
		<div class="col-md-6" id="banner-col2">
			<img
	...
	<div class="container-fluid" id="product-container">
		...
		<div class="col-md-6" id="product-col2">
			<h3>Our Top 5 Product List</h3>

			<ul>
			<li>Employee Management ReactJS and Springboot end-to-end Website(MysqlDB)</li>
			<li>Student application Spring boot and Angular crud oprations and registration with authentication</li>
			<li>Shoping Mart Using React and NodeJS</li>
			<li>Train booking system Sping boot and mysql</li>
	...
	<div class="d-grid gap-2 d-md-flex justify-content-center">
		...
		<div class="col-md-4 social-col">
			<a href="http:/instagram/__yashiv_"
			><img
				class="img-responsive rounded mx-auto d-block"
...
<p>Email Us- kshivakumar7227@gmail.com</p>

			</div>

			<div class="col-md-4" id="footer-col2">
			<h3>If you want to Subscribe to my Youtube Java18</h3>
			<form>
				<div class="mb-3">
				<input
					type="email"
